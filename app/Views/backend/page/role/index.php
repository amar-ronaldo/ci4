                ...
                <div class="col-md-12 col-xl-12 col-sm-12  pl-0 pr-0 form-filter d-none">
                    <div class="block block-themed">
                        ...
                        <div class="block-content">
                            <div class="row">
                                <?=form_filter_text(['label'=>'Name','name'=>'user_groups-name']);?>
                            </div>
                                    <div class="row">
                                <?=form_filter_text(['label'=>'Create by','name'=>'b-name']);?>
                                <?=form_filter_daterange(['label'=>'Create at','name'=>'user_groups-created_at']);?>
                                <?=form_filter_text(['label'=>'Update by','name'=>'c-name']);?>
                                <?=form_filter_daterange(['label'=>'Update at','name'=>'user_groups-updated_at']);?>
