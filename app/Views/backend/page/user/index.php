                ...
                <div class="col-md-12 col-xl-12 col-sm-12  pl-0 pr-0 form-filter d-none">
                    <div class="block block-themed">
                        ...
                        <div class="block-content">
                            <div class="row">
                                <?=form_filter_text(['label'=>'Nama','name'=>'users-name']);?>
                                <?=form_filter_text(['label'=>'Username','name'=>'users-username']);?>
                                <?=form_filter_text(['label'=>'Email','name'=>'users-email']);?>
                                <?=form_filter_text(['label'=>'Role','name'=>'e-name']);?>
    ...
    jQuery(function() {
        jQuery('#form').validate({
            ...
            messages: {
                ...
                'username': {
                    required: 'Usernama tidak boleh kosong',
                },
                'role': {
