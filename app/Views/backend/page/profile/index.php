...
<div class="bg-image" style="background-image: url('<?= base_url('assets/media/photos/photo8@2x.jpg') ?>');">
    <div class="bg-black-75">
        <div class="content content-full text-center">
            <div class="my-3">
                <img class="img-avatar img-avatar-thumb" src="<?= base_url('assets/media/avatars/'.( $user['avatar'] ?: 'avatar.jpg')) ?>" alt="">
            </div>
...
<div class="content ">
        ...
        <div class="col-6">
            ...
            <div class="block block-rounded block-themed">
                ...
                <div class="block-content">
                    <?= form_open_multipart('backend/profile/edit/'.$user['id'], ['class' => 'myform', 'id' => 'formUser']) ?>
                    <div class="row push">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="form-group">
                                ...
                                <?= form_input(['class' => 'form-control', 'name' => 'username', 'value' => $user['username'] ?: '', 'placeholder' => 'username', 'id' => 'username']) ?>
                            </div>
                            <div class="form-group">
                                <?= form_label(pascalize('name'), 'name') ?>
                                <?= form_input(['class' => 'form-control', 'name' => 'name', 'value' => $user['name'] ?: '', 'placeholder' => 'name', 'id' => 'name']) ?>
                            </div>
                            <div class="form-group">
                                <?= form_label(pascalize('email'), 'email') ?>
                                <?= form_input(['class' => 'form-control', 'name' => 'email', 'value' => $user['email'] ?: '', 'placeholder' => 'email', 'id' => 'email']) ?>
                            </div>
                            <div class="form-group">
                                ...
                                <?= form_upload([
                                    'type' => 'image',
                                    // 'type' => 'image',
                                    'thumb' => $user['avatar'] ?'assets/media/avatars/'.$user['avatar']: 'assets/media/avatars/avatar.jpg',
                                    'name' => 'avatar',
                                    'id' => 'avatar',
                                ]) ?>
                                <br><small><?= form_label('Size: 64x64 px', 'info-avatar', ['class' => 'text-muted']) ?></small>
    ...
    <div class="block block-rounded block-themed">
        ...
        <div class="block-content">
            <?= form_open('backend/profile/changePassword/'.$user['id'], ['class' => 'myform', 'id' => 'formPassword']) ?>
